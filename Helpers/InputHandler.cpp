...
//    view_shortened_templates(this->payload);
//    string name;
//    cout << "Enter the name of the template you want to view." << endl;
//    cin >> name;
//    auto species_index = get_index_species(name, this->payload);
//    auto role_index = get_index_roles(name, this->payload);
...
//    }
//    view_single_template(species_index, role_index, this->payload);
//
